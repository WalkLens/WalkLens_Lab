...
namespace Microsoft.Azure.SpatialAnchors.Unity
{
    ...
    public static class SpatialAnchorExtensions
    {
        ...
        /// Thrown if <paramref name="gameObject"/> is inactive.
        /// </exception>
        static public ARAnchor CreateNativeAnchor(this GameObject gameObject)
        {
            ...
            // Check activeness of gameObject
...
#if (UNITY_WSA || WINDOWS_UWP) && ASA_UNITY_USE_OPENXR
            // Set the OpenXR Handle
            cloudSpatialAnchor.OpenXrAnchor = AnchorConverter.ToOpenXRHandle(anchor.nativePtr);

            // OpenXrAnchor Handle is used for platform key mapping since cloudSpatialAnchor 
            // identifier may not be available at time of storage.
